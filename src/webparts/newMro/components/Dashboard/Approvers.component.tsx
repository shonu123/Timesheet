                 ...
                 if(TimeOffRec.length)
                        {
                            ...
                            {
                                if(IsReportingManagerReviewerSame && this.state.userGroups.includes('Timesheet HR')) // ReportingManager/Reviewer/HR same
                                {
                                    //Timesheet data
                                ...
                                else if(IsReportingManagerReviewerSame) // ReportingManager/Reviewer same
                                {
                                    //Timesheet data
