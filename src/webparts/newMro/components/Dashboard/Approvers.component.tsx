...
export interface ApproversPropsState {
...
class ApproversApprovals extends React.Component<ApproversProps, ApproversPropsState> {
    ...
    private ReviewerApproval = async () => {
        ...
        var filterString = "Approvers/Id eq '"+userId+"' and PendingWith eq 'Approver' and Status eq 'Submited'"
        ...
        return (
            ...
            <div>
                <div className='table-head-1st-td'>
                    <TableGenerator columns={columns} data={this.state.Approvers} fileName={'Reviewes Approvals'} showExportExcel={false}></TableGenerator>
                </div>
            </div>
