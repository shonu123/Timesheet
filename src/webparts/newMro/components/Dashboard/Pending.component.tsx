...
class Pending extends React.Component<PendingProps,PendingState> {
    ...
    private loadListData = () => {
        ...
        var filterString = `(Modified ge datetime'${last30days.toISOString()}' and Modified le datetime'${addonemoreday.toISOString()}' and IsActive ne 0 and Status eq '${ApprovalStatus.InProgress}')`;
