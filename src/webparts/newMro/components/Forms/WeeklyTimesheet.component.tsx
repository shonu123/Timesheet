...
//---------------------------------------------------   
    ...
    private async loadWeeklyTimeSheetData(currentUserId) {
        ...
        ClientsFromClientMaster.filter(ClientItem=>{ //to filter only active client names
         ...
         this.WeekHeadings=[];
         this.WeekHeadings.push({"Mon":(new Date(WeekStartDate).getDate().toString().length == 1 ? "0" +WeekStartDate.getDate() :WeekStartDate.getDate())+' '+this.state.Months[new Date(WeekStartDate).getMonth()],
