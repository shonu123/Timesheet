...
const DatePickercontrol = (props, ref) => {
  ...
  let disabledDayIndexes = ![null, undefined, ''].includes(props.disabledDayIndexes) ? props.disabledDayIndexes : [];
  ...
  const filterDays = (date, disabledDayIndexes: any) => {
  let currentDate = new Date(date);
  return !disabledDayIndexes.includes(currentDate.getDay());
}
  return (
    //   <span>abc</span>
    //   <DatePicker
    ...
    customDate ? <div className="date-picker-container">
      ...
      <div className="date-picker-container">
        ...
        <DatePicker
          ...
          filterDate={date => filterDays(date, disabledDayIndexes)}
        //  dayClassName={customDayClassName}
        //  renderDayContents={customDayRender}
        />
      </div>
