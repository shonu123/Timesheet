...
import HQTimesheet from './components/HQTimesheet';
import { IHQTimesheetProps } from './components/IHQTimesheet';
...
export default class Timesheet extends BaseClientSideWebPart<ITimesheetProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IHQTimesheetProps> = React.createElement(
      HQTimesheet,
      {
