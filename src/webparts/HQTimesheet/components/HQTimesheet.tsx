...
import { IHQTimesheetProps } from './IHQTimesheet';
...
export default class HQTimesheet extends React.Component<IHQTimesheetProps, {}> {
  public state = {
  ...
  public render(): React.ReactElement<IHQTimesheetProps> {
    const {
