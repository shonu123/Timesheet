...
// import ModalForwardApprovals from '../components/Shared/ModalForwardApprovals.component';
// import TableGenerator from '../components/Shared/TableGenerator';
// import { faEye } from '@fortawesome/free-solid-svg-icons';
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import DatePicker from "../components/Shared/DatePickerField";
...
// class DelegateManagerApprovals extends React.Component<DelegateReviewerProps, DelegateReviewerState> {
//     private Reviewer;
//     private DelegateTo;
//     private From;
//     private To;
...
//         ])
//         let isAdmin = false,userGroups = [],ClientDeligates = [],Reviewers =[],ClientReviewers = [],ReviewersObj=[]
...
//                 }
//             }
//             ClientReviewers.push({Client:Reviewer.ClientName,Reviewers:Reviewer.Reviewers})
//         }
//         //  --MLC
//         if(!isAdmin){
//                 this.setState({ReviewersObj: ReviewersObj,ClientDeligatesObj:ClientDeligates,ClientReviewersObj:ClientReviewers,userGroups:userGroups,isAdmin:isAdmin,showToaster:true,DelegateToObj: ReviewersObj,DelegateToName:''});
...
//         }
//         else{
//         this.setState({ReviewersObj: ReviewersObj,DelegateToObj: ReviewersObj,ClientDeligatesObj:ClientDeligates,ClientReviewerObj:ClientReviewers,DelegateToName:'',userGroups:userGroups,isAdmin:isAdmin,showToaster:true,loading:false})
//         }
...
//        //MLC
//         this.setState({ReviewersObj: ReviewersObj,ClientDeligatesObj:ClientDeligates,ClientReviewerObj:ClientReviewers,userGroups:userGroups,isAdmin:isAdmin,showToaster:true,ReviewerId:ReviewerId,DelegateToId:DelegateToId,Client:selectedClient,DelegateToObj: ReviewersObj,From:From,To:To,Comments:Comments,ActionHistory:ActionHistory,PreviousDateHistory:PreviousDateHistory,ItemID:ItemID,DelegateToName:DelegateToName,loading:false});
//     }
...
//     handleSubmit = () =>{
//         let data = {
//             Reviewer: { val: this.state.ReviewerId, required: true, Name: 'Reviewer', Type: ControlType.string, Focusid: this.Reviewer },
...
//                                                     <select className="form-control" required={true} name="ReviewerId" title="Reviewer" id='ddlReviewer' ref={this.Reviewer} onChange={this.handleChangeEvents}>
...
//                                                         <input className="txtManagerName form-control" required={true} name="Reviewer" title="Reviewer" value={this.state.ReviewerName} readOnly />
//                                                     </div>
//                                                 </div> 
//                                             }
