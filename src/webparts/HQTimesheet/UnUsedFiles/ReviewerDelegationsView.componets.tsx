...
// export interface ReviewerDelegationsViewProps {
//     match: any;
//     spContext: any;
...
//     history: any;
// }
// export interface ReviewerDelegationsViewState {
// }

// class ReviewerDelegationsView extends React.Component<ReviewerDelegationsViewProps, ReviewerDelegationsViewState> {
//     private siteURL;
//     constructor(props: ReviewerDelegationsViewProps) {
//         super(props);
...
//             sp.web.lists.getByTitle('Delegations').items.expand('Reviewer,DelegateTo').select('Reviewer/Title,Reviewer/ID,DelegateTo/Title,DelegateTo/ID,*').orderBy('Reviewer/Title', true).getAll(),
...
//                     })
//         }
//         this.setState({isAdmin:isAdmin,ReviewerDelegates:tableDataObj,ExcelData:excelData,loading:false})
//     }
...
//                                 <NavLink title="Edit"  className="csrLink ms-draggable" to={`/DelegateReviewTimesheets/${record.Id}`}>
...
//                         <React.Fragment>
//                             <div style={{ paddingLeft: '10px' }}>
//                                 <NavLink title="View"  className="csrLink ms-draggable" to={`/DelegateReviewTimesheets/${record.Id}`}>
...
//             let url = `/DelegateReviewTimesheets/${this.state.RecordID}`;
...
// export default ReviewerDelegationsView